...
CTLEXT_INLINE CTreeCursor::CTreeCursor(HTREEITEM hTreeItem,CTreeCtrlEx* pTree) :    m_hTreeItem(hTreeItem), m_pTree(pTree)
	{ }
CTLEXT_INLINE CTreeCursor::CTreeCursor(const TREECLICKA& info) :    m_hTreeItem( info.hit_info.hItem ), m_pTree( info.pClass )
	{ }
CTLEXT_INLINE CTreeCursor::CTreeCursor(const CTreeCursor& posSrc)
	{ *this = posSrc; }
CTLEXT_INLINE CTreeCursor::~CTreeCursor()
	{ }
CTLEXT_INLINE CTreeCursor::operator HTREEITEM( ) const
	{ return m_hTreeItem; }

CTLEXT_INLINE bool CTreeCursor::IsValid( ) const
	{ return m_hTreeItem != NULL; }

CTLEXT_INLINE void CTreeCursor::SetInvalid( )
	{ m_hTreeItem= NULL; }

CTLEXT_INLINE CTreeCursor CTreeCursor::InsertAfter( LPCTSTR strItem, HTREEITEM hAfter, int nImageNorm, int nImageSel )
	{ return _Insert( strItem, nImageNorm, nImageSel, hAfter ); }

CTLEXT_INLINE CTreeCursor CTreeCursor::AddHead( LPCTSTR strItem, int nImageNorm, int nImageSel )
	{ return _Insert( strItem, nImageNorm, nImageSel, TVI_FIRST ); }

CTLEXT_INLINE CTreeCursor CTreeCursor::AddTail( LPCTSTR strItem, int nImageNorm, int nImageSel )
	{ return _Insert( strItem, nImageNorm, nImageSel, TVI_LAST ); }
...
CTLEXT_INLINE DWORD CTreeCursor::GetData( ) const
...
CTLEXT_INLINE BOOL CTreeCursor::SetImage( int nImage, int nSelectedImage )
	{ return m_pTree->SetItemImage(m_hTreeItem,nImage,nSelectedImage == -1 ? nImage : nSelectedImage); }
...
CTLEXT_INLINE BOOL CTreeCursor::Collapse( )
	{ return m_pTree->Expand(m_hTreeItem,TVE_COLLAPSE); }
...
CTLEXT_INLINE CTreeCtrlEx& CTreeCursor::GetTreeCtrl( )
	{ return *m_pTree; }
